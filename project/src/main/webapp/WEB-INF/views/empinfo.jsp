	...
	<script type="text/javascript">	
		...
		<div class="col-xs-10 right">
			<form name="infofrm" id="infofrm">
				...
				<!-- <input type="text" value="${empBasicinfo.AUTH_CLS_CODE}"> -->
...
--%>						
		    ...
		    <input type="hidden" name="auth_cls_code" id="auth_cls_code" value="${empBasicinfo.AUTH_CLS_CODE}">
				<%--  <input type="text" id="auth_cls_code" value="${empBasicinfo.AUTH_CLS_CODE}"> --%>		    
							...
							<div class="input-group">
						    	...
						    	<select class="form-control" name="emp_stts_code" id="EMP_STTS_CODE"> 
									...
									<c:forEach var="emp_stts" items="${groupCode.EMP_STTS_CODE}">
										<option value="${emp_stts.CODE_ID}" class="${emp_stts.CODE_ID}"
						  	...
						  	<table class="table table-bordered" id="basic-info">
							    <tbody>			
							    	<tr>
								       ...
								       <c:set var="ref_no" value="${empBasicinfo['RSDN_REG_NO']}"/>
							
								       <td colspan="3">
								       		<input type="text" class="basictext" value="${fn:substring(ref_no,0,6) }" name="rsdn_reg_no_1" placeholder="" maxlength='6'>
								       		&nbsp;&nbsp; - &nbsp;&nbsp;
								       		<input type="passwd" class="basictext" value="${fn:substring(ref_no,6,13) }" name="rsdn_reg_no_2" placeholder="" maxlength='7'>								       		 
								       </td>
								     </tr>
								     <tr>
								       <td class="name">한문</td>
